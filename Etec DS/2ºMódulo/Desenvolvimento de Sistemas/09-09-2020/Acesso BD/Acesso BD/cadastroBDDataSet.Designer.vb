...
Partial Public Class cadastroBDDataSet
    ...
    Partial Public Class CadastroDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddCadastroRow(ByVal Nome As String, ByVal Endereco As String, ByVal CEP As String, ByVal Estado As String) As CadastroRow
            Dim rowCadastroRow As CadastroRow = CType(Me.NewRow,CadastroRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nome, Endereco, CEP, Estado}
...
Namespace cadastroBDDataSetTableAdapters
    ...
    Partial Public Class CadastroTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cadastro` (`Nome`, `Endereco`, `CEP`, `Estado`) VALUES (?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Cadastro` SET `Nome` = ?, `Endereco` = ?, `CEP` = ?, `Estado` = ? WHERE ("& _ 
                "(`Código` = ?) AND ((? = 1 AND `Nome` IS NULL) OR (`Nome` = ?)) AND ((? = 1 AND "& _ 
                "`Endereco` IS NULL) OR (`Endereco` = ?)) AND ((? = 1 AND `CEP` IS NULL) OR (`CEP"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Acesso_BD.My.MySettings.Default.cadastroBDConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Código, Nome, Endereco, CEP, Estado FROM Cadastro"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Código As Integer, ByVal Original_Nome As String, ByVal Original_Endereco As String, ByVal Original_CEP As String, ByVal Original_Estado As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Nome As String, ByVal Endereco As String, ByVal CEP As String, ByVal Estado As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Nome As String, ByVal Endereco As String, ByVal CEP As String, ByVal Estado As String, ByVal Original_Código As Integer, ByVal Original_Nome As String, ByVal Original_Endereco As String, ByVal Original_CEP As String, ByVal Original_Estado As String) As Integer
            If (Nome Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_CEP,String)
            End If
            If (Original_Estado Is Nothing) Then
